 ...
 *
 * Usage: node social/manga-demo/build.mjs
...
function mergeAudio() {
  ...
  const audio = resolve(__dirname, "manga-narration.wav");
  const output = resolve(__dirname, "manga-demo-final.mp4");

  if (!existsSync(audio)) {
    console.log("  ⚠ manga-narration.wav not found. Copying video without audio.");
  ...
  console.log(`    → manga-demo-final.mp4 (${parseFloat(dur).toFixed(1)}s)`);
}

async function main() {
  console.log("╔══════════════════════════════════════╗");
  console.log("║   Manga Demo — Short Video Builder   ║");
  console.log("╚══════════════════════════════════════╝\n");
  ...
  console.log("\n✓ Done! → social/manga-demo/manga-demo-final.mp4");
}
